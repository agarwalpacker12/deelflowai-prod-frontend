...
const loadLeaflet = async () => {
  ...
  try {
    ...
    MapContainer =
      leafletModule.MapContainer || leafletModule.default?.MapContainer;
    ...
    useMapEvents =
      leafletModule.useMapEvents || leafletModule.default?.useMapEvents;
    ...
    console.warn(
      "react-leaflet not available, LocationPicker will be disabled:",
      error
    );
    return false;
  }
    ...
    >
      <Popup>
        <div className="text-sm">
          ...
          <p className="text-xs text-gray-500 mt-1">Drag marker to adjust</p>
        </div>
      </Popup>
    </Marker>
  ) : null;
...
const LocationPicker = ({
  ...
  useEffect(() => {
    ...
    if (USE_LEAFLET && typeof window !== "undefined") {
      loadLeaflet()
        ...
        .catch((err) => {
          console.warn(
            "Failed to load react-leaflet, showing placeholder:",
            err
          );
  ...
  if (
    ...
    return (
      <div className="w-full rounded-xl overflow-hidden border-2 border-gray-200 shadow-lg">
        <div
          className="relative bg-gradient-to-br from-blue-50 to-indigo-50 flex items-center justify-center"
        ...
        >
          <div className="text-center p-8 max-w-md">
            ...
            <p className="text-sm text-gray-500">
              Please use the location fields above to enter coordinates
              manually.
            </p>
          </div>
        </div>
  ...
  if (typeof MapContainer !== "function" || typeof TileLayer !== "function") {
    console.error(
      "MapContainer or TileLayer is not a function, showing placeholder"
    );
    return (
      <div className="w-full rounded-xl overflow-hidden border-2 border-gray-200 shadow-lg">
        <div
