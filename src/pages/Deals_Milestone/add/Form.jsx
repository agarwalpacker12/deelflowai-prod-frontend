...
const AddDealMilestoneForm = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await dealMilestonesAPI.createMilestone(apiData);
      if (response.data && (response.data.status === "success" || response.status === 201)) {
        setSubmitStatus("success");
        setSubmitMessage("Milestone created successfully!");
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-black ${errors.deal_id ? "border-red-500" : "border-gray-300"}`}
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-black ${errors.milestone_type ? "border-red-500" : "border-gray-300"}`}
                >
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-black ${errors.due_date ? "border-red-500" : "border-gray-300"}`}
                />
                {errors.due_date && (
              ...
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-black ${errors.title ? "border-red-500" : "border-gray-300"}`}
